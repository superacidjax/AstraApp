class CreateFlowRecipients < ActiveRecord::Migration[7.2]
  def change
    create_table :flow_recipients, id: :uuid do |t|
      t.references :flow, null: false, foreign_key: true, type: :uuid
      t.string :person_id, null: false # UUID for the person from ActiveResource
    ...
    add_index :flow_recipients, :person_id
