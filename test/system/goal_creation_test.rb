...
#   end
#
#   test "user creates a new goal with PersonRule" do
#     visit new_goal_path
#
#     fill_in "Name", with: "Health Improvement Goal"
#     fill_in "Description", with: "Reduce BMI and ensure no allergy issues"
#
#     within("[data-test-id='initial-state-section']") do
#       fill_in "Name", with: "BMI 25"
#       find("select[id^=traits_]", visible: :all).select("BMI")
#       find("select[id^=operator_]", visible: :all).select("Less than")
#       fill_in "Value (Numeric)", with: "25"
#     end
#
#     within("[data-test-id='end-state-section']") do
#       fill_in "Name", with: "Allergy Peanut"
#       find("select[id^=traits_]", visible: :all).select("Allergy")
#       find("select[id^=operator_]", visible: :all).select("Equals")
...
#     assert_text "Reduce BMI and ensure no allergy issues"
#     assert_text "Initial State Rule"
#     assert_text "BMI 25"
#     assert_text "End State Rule"
